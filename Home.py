...
DEFAULT_FOUNDATIONS = {
    ...
    'F3': {
        ...
        'piles': 3,
        'color': '#FFA726',
        'coords': [(0, 0.866), (-0.75, -0.433), (0.75, -0.433)]
    },
    ...
    'F4': {
        ...
        'piles': 4,
        'color': '#4ECDC4',
        'coords': [(-0.75, -0.75), (0.75, -0.75), (-0.75, 0.75), (0.75, 0.75)]
    },
    ...
    'F5': {
        ...
        'piles': 5,
        'color': '#45B7D1',
        'coords': [(0, 0), (-0.75, -0.75), (0.75, -0.75), (-0.75, 0.75), (0.75, 0.75)]
    },
    ...
    'F7': {
        ...
        'coords': [
            (0, 0),  # Center
            (0.75, 0),  # Right
            (0.375, 0.649),  # Top-right
            (-0.375, 0.649),  # Top-left
            (-0.75, 0),  # Left
            (-0.375, -0.649),  # Bottom-left
            (0.375, -0.649)  # Bottom-right
        ]
    },
    ...
    'F8': {
        ...
        'color': '#DDA0DD',
        'coords': [
            (-0.75, -1.125), (0.75, -1.125),
            (-0.75, -0.375), (0.75, -0.375),
            (-0.75, 0.375), (0.75, 0.375),
            (-0.75, 1.125), (0.75, 1.125)
        ]
    },
