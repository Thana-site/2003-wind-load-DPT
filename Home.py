...
DEFAULT_FOUNDATIONS = {
    'F1': {'name': '2-Pile Square', 'piles': 2, 'color': '#FF6B6B',
           'coords': [(0, 0)]},     
    'F2': {'name': '2-Pile Square', 'piles': 2, 'color': '#FF6B6B',
    ...
    'F5': {'name': '5-Pile Square', 'piles': 5, 'color': '#45B7D1',
           'coords': [(0, 0),(-0.7, 0.7), (0.7, 0.7), (-0.7, -0.7), (0.7, -0.7)]},
    ...
    'F7': {'name': '7-Pile Hexagon+Center', 'piles': 7, 'color': '#FFEAA7',
           'coords': [(0, 0), (0.7, 0.45), (0.7, -0.45), (-0.7, 0.45), (-0.7, -0.45), (0, -1.150), (0, 1.150)]},
    ...
    'F9': {'name': '9-Pile Square 3×3', 'piles': 9, 'color': '#98D8C8',
           'coords': [(-0.9, 0), (0, 0), (0.9, 0), (-0.9, 0.9), (0, 0.9), (0.9, 0.9), (-0.9, -0.9), (0, -0.9), (0.9, -0.9)]},
}
...
LOAD_COMBINATIONS = {
    ...
    "SERV :D - Ex",
    "SERV :D - Ey",
    "SERV :D + (L) + (1.0)(RSA_Ex(RS)+RSA_Ex(ES))",
    "SERV :D + (L) + (1.0)(RSA_Ex(RS)-RSA_Ex(ES))",
    "SERV :D + (L) + (1.0)(RSA_Ey(RS)+RSA_Ey(ES))",
    "SERV :D + (L) + (1.0)(RSA_Ey(RS)-RSA_Ey(ES))",
    "SERV :D + (L) - (1.0)(RSA_Ex(RS)+RSA_Ex(ES))",
    "SERV :D + (L) - (1.0)(RSA_Ex(RS)-RSA_Ex(ES))",
    "SERV :D + (L) - (1.0)(RSA_Ey(RS)+RSA_Ey(ES))",
    "SERV :D + (L) - (1.0)(RSA_Ey(RS)-RSA_Ey(ES))",
    "SERV :D + (1.0)(RSA_Ex(RS)+RSA_Ex(ES))",
    "SERV :D + (1.0)(RSA_Ex(RS)-RSA_Ex(ES))",
    "SERV :D + (1.0)(RSA_Ey(RS)+RSA_Ey(ES))",
    "SERV :D + (1.0)(RSA_Ey(RS)-RSA_Ey(ES))",
    "SERV :D - (1.0)(RSA_Ex(RS)+RSA_Ex(ES))",
    "SERV :D - (1.0)(RSA_Ex(RS)-RSA_Ex(ES))",
    "SERV :D - (1.0)(RSA_Ey(RS)+RSA_Ey(ES))",
